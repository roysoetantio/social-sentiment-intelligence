/**
 * Canonical URL → channel classification, shared by ingest and backfill.
 *
 * Both writers MUST use this. When they had separate copies, the same outlet
 * landed under different platforms depending on which script saved the row —
 * thestar.com.my ended up 23 "Web" and 17 "News". One domain, one channel.
 *
 * Adding an outlet: put it in NEWS_DOMAINS. Adding a social network: add it to
 * SOCIAL_HOSTS *and* to PLATFORMS in src/components/filters/FilterBar.jsx,
 * or the rows exist but cannot be filtered.
 */
